        ...
        <>
            <div className={classNames(styles.root, className)}>
                ...
                <div className={styles.list_menu}>
                    <div className={styles.voltage_button}>
                        <button className={styles.voltage_button}>All</button>
                        <svg
                            version="1.1"
                        ...
                        >
                            ...
                            <path
                                className={classNames(styles.voltage, styles.line_1)}
                            ...
                            ></path>
                            <path
                                className={classNames(styles.voltage, styles.line_2)}
                        ...
                        <div className={styles.dots}>
                            <div className={classNames(styles.dot, styles.dot_1)}></div>
                            <div className={classNames(styles.dot, styles.dot_2)}></div>
                            <div className={classNames(styles.dot, styles.dot_3)}></div>
                            <div className={classNames(styles.dot, styles.dot_4)}></div>
                            <div className={classNames(styles.dot, styles.dot_5)}></div>
                        </div>
                    </div>
                    <div className={styles.voltage_button}>
                        <button className={styles.voltage_button}>Burger</button>
                        <svg
                            version="1.1"
                            xmlns="http://www.w3.org/2000/svg"
                            x="0px"
                    ...
                    <div className={styles.voltage_button}>
                        <button className={styles.voltage_button}>Pizza</button>
                        <svg
                            version="1.1"
                            xmlns="http://www.w3.org/2000/svg"
                            x="0px"
                    ...
                    <div className={styles.voltage_button}>
                        <button className={styles.voltage_button}>Pasta</button>
                        <svg
                            version="1.1"
                            xmlns="http://www.w3.org/2000/svg"
                            x="0px"
                    ...
                    <div className={styles.voltage_button}>
                        <button className={styles.voltage_button}>Fries</button>
                        <svg
                            version="1.1"
                            xmlns="http://www.w3.org/2000/svg"
                            x="0px"
